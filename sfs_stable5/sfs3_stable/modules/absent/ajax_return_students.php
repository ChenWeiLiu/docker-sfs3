...
if ($_POST['the_class']) {
  ...
  $seme_year_seme=sprintf("%03d%d",curr_year(),curr_seme()); 
	...
	$query="select a.student_sn,a.seme_num,b.stud_name from stud_seme a,stud_base b where a.seme_year_seme='$seme_year_seme' and a.seme_class='".$_POST['the_class']."' and a.student_sn=b.student_sn and b.stud_study_cond = 0 order by seme_num";
