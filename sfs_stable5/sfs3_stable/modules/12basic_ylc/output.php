...
if($_POST['act']){
	...
	while(!$recordSet->EOF){
		...
		$guardian_phone=$stud_tel_2?$stud_tel_2:$domicile_data[$student_sn]['guardian_phone'];
		$guardian_hand_phone=$student_data[$student_sn]['stud_tel_3']?$student_data[$student_sn]['stud_tel_3']:$domicile_data[$student_sn]['guardian_hand_phone'];
