...
$MODULE_PRO_KIND_NAME = "轉換產出UTF-8編碼資料庫";
...
$school_menu_p = array(
    "index1.php"=>"檢視資料庫",
    "transfer.php"=>"產出UTF8MB4編碼的資料庫",
    "transfer_utf8.php"=>"產出UTF8編碼的資料庫",
    "compare.php"=>"轉換前後資料庫比對",
);
