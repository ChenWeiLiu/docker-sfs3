...
if ($_POST['act']=='start') {
    ...
    if ($_POST['delete_exist_database']==1) {
        ...
        $db_sql="CREATE DATABASE ".$utf8_db." DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_unicode_ci;";
...
/*** 開始依序處理每個 table  *****/
    foreach ($_POST['TABLES'] as $table_name) {
        ...
        if ($table_name=='file_db' or $table_name=='health_exam_record') {
            $new_create_sql = $O[0] . " ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci";
        } else {
            $new_create_sql = $O[0] . " ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci";
        }
        ...
        <table border="1" style="border-collapse:collapse;background-color: #d3d599;border-color: #000a28;font-size:10pt">
            <tr>
                <td style="padding:10px">
                    ...
                    為了讓 SFS3U 能支援更多少見的中文字，之後的版本將採用 utf8mb4 編碼。<br>
                    注意！您的 MySQL 版本必須 5.5.3 之後才能支援 utf8mb4 編碼！<br><br>

                    如果您的 MySQL 版本小於 5.5.3 , 您的做法如下:<br><br>
                    1.利用這支程式先將資料轉換成 utf8 。<br>
                    2.然後利用 mysqldump 方式把資料庫匯出成文字檔。<br>
                    3.匯入 SFS3U 主機內 (注意! SFS3U 主機的 MySQL 版本務必為 5.5.3 以上)。<br>
                    4.利用官方提供的轉碼程式，將資料庫的編碼轉換為 utf8mb4。<br>
